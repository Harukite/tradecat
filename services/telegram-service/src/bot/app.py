...
class UserRequestHandler:
    ...
    def get_position_ranking(self, limit=10, sort_order='desc', period='24h', sort_field: str = "position"):
        """获取持仓量排行榜 - 委托给TradingSuperheroBot处理"""
        global bot
        if bot:
    ...
    def get_position_ranking_keyboard(self, current_sort='desc', current_limit=10, current_period='24h'):
        """获取持仓量排行榜键盘 - 委托给TradingSuperheroBot处理"""
        global bot
        if bot:
...
def add_signal_formatting_to_bot():
    """为TradingSuperheroBot类添加信号格式化方法"""
    ...
    # 将方法添加到TradingSuperheroBot类
    TradingSuperheroBot.format_signal_message = format_signal_message
    TradingSuperheroBot.send_formatted_signal = send_formatted_signal
    TradingSuperheroBot.get_formatted_signal_preview = get_formatted_signal_preview
    TradingSuperheroBot.send_message_to_user = send_message_to_user
    TradingSuperheroBot.send_signal_to_user = send_signal_to_user
    TradingSuperheroBot.start_bot = start_bot
    TradingSuperheroBot.stop_bot = stop_bot
    
    logger.info("✅ 信号格式化和发送方法已添加到TradingSuperheroBot类")
